...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> CARECONNECT Hospital </a>
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;font-weight: 900;
    color: blue;"> Welcome &nbsp Dr.<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td style="width: 50%;"><?php echo $row['prescription'];?></td>
